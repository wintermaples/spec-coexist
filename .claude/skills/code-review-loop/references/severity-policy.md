...
If the reviewer is technically wrong, the agent **SHOULD** push back using the `code-review-loop` skill's rules (technical reasoning, reference to code/tests). Pushback is legitimate; performative agreement is not.
