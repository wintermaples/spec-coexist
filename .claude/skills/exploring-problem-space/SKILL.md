...
This skill **MUST NOT** invoke or delegate to any `superpowers:*` skill. The `spec-coexist` suite owns its own divergent-phase discipline; see `../using-spec-coexist/references/independence.md`.
