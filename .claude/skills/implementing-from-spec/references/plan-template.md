...
The plan the agent presents to the user **MUST** contain all five sections below. Do not omit any section, even when it seems short.
...
### 4. Test Strategy
List the tests to be added or modified, the existing tests that are relevant, and how the agent will confirm the implementation is correct. "Run the test suite" alone is not a test strategy — name the specific test scenarios.

### 5. Open Questions / Risks
Anything still unclear about the requirements or design, any technical risk, and any dependency that could block a step.
