...
**Why:** Multi-purpose skills defeat description-based triggering (the trigger phrases become diluted) and make the ordered steps branchy and fragile. Splitting produces two sharper skills, and the suite's orchestration layer (`using-spec-coexist`) handles the routing for free.
