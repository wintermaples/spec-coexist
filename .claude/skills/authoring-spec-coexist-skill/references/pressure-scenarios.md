...
Applies to: `creating-requirements`, `creating-basic-design`, `revising-spec`, `exploring-problem-space`.
...
Applies to: `implementing-from-spec`, `revising-implementation`, `test-driven-implementation` (Phase 1).
...
Applies to: `verification-before-completion`, `requesting-code-review`, `receiving-code-review`, `enforcing-code-discipline` (Phase 2).
...
Applies to: `authoring-spec-coexist-skill`, `using-spec-coexist`.
